---
layout: default
title: "Publications — Ultrasound / POCUS"
description: "Shepherd Research Lab publications tagged ultrasound."
auto_generated: true
---
...
# Ultrasound / POCUS — Publications

Papers tagged `ultrasound` — 
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'ultrasound'" %}
