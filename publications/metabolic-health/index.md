---
layout: default
title: "Publications — Metabolic Health"
description: "Shepherd Research Lab publications tagged metabolic-health."
auto_generated: true
---
...
Papers tagged `metabolic-health` — Metabolic syndrome, obesity, cardiometabolic risk
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'metabolic-health'" %}
