...
description: "Shepherd Research Lab publications tagged impact."
auto_generated: true
---
...
Papers tagged `impact` — UG3/UH3 cooperative agreement study
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'impact'" %}
