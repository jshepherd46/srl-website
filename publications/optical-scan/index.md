---
layout: default
title: "Publications — 3D Optical Scanning"
description: "Shepherd Research Lab publications tagged optical-scan."
auto_generated: true
---
...
# 3D Optical Scanning — Publications

Papers tagged `optical-scan` — 
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'optical-scan'" %}
