---
layout: default
title: "Publications — NHANES"
description: "Shepherd Research Lab publications tagged nhanes."
auto_generated: true
---
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'nhanes'" %}
