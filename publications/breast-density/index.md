---
layout: default
title: "Publications — Breast Density"
description: "Shepherd Research Lab publications tagged breast-density."
auto_generated: true
---
...
# Breast Density — Publications

Papers tagged `breast-density` — Mammographic density measurement and risk
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'breast-density'" %}
