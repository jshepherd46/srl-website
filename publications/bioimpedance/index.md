---
layout: default
title: "Publications — Bioimpedance"
description: "Shepherd Research Lab publications tagged bioimpedance."
auto_generated: true
---
...
# Bioimpedance — Publications

Papers tagged `bioimpedance` — 
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'bioimpedance'" %}
