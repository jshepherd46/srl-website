---
layout: default
title: "Publications — Makawalu"
description: "Shepherd Research Lab publications tagged makawalu."
auto_generated: true
---
...
# Makawalu — Publications

Papers tagged `makawalu` — XAI concept bottleneck model for POCUS breast cancer detection in USAPI
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'makawalu'" %}
