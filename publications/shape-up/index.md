---
layout: default
title: "Publications — Shape Up!"
description: "Shepherd Research Lab publications tagged shape-up."
auto_generated: true
---
...
# Shape Up! — Publications

Papers tagged `shape-up` — 3D optical body scanning and blood biomarkers across the lifecourse
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'shape-up'" %}
