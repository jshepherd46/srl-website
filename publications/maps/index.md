...
description: "Shepherd Research Lab publications tagged maps."
auto_generated: true
---
...
Papers tagged `maps` — Morphometric analysis of DXA images at population scale
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'maps'" %}
