---
layout: default
title: "Publications — Risk Modeling"
description: "Shepherd Research Lab publications tagged risk-modeling."
auto_generated: true
---
...
# Risk Modeling — Publications

Papers tagged `risk-modeling` — Cancer risk prediction and biomarker development
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'risk-modeling'" %}
