---
layout: default
title: "Publications — Body Composition Lab"
description: "Shepherd Research Lab publications tagged bcepem."
auto_generated: true
---
...
# Body Composition Lab — Publications

Papers tagged `bcepem` — Clinical body composition assessment services
...
{% assign filtered = filtered | where_exp: "p", "p.tags contains 'bcepem'" %}
